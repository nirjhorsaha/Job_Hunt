...
const SingleJobs = ({job}) => {
    console.log(job);
    const { company_logo, company_name, job_title, location, remote_or_onsite, salary, job_description, job_responsibility, educational_requirements, experiences } = job;
    return (
        <div>
